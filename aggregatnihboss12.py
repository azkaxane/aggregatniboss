...
with tab2:
    ...
    # Gunakan palet Coral Wave: Demand=#FFD464, Total Produksi=#FFD464
    v1, v2 = st.columns(2)
    with v1:
        fig_dp = go.Figure()
    ...
    with v4:
        fig_os = go.Figure()
        fig_os.add_trace(go.Bar(x=df_selected["Periode"], y=df_selected["OT Production"], name="Overtime Vol", marker_color='#FFD464'))
        fig_os.add_trace(go.Bar(x=df_selected["Periode"], y=df_selected["Subcontracting"], name="Subcontract Vol", marker_color='#FFD464'))
