...
def calculate_aggregate_planning(strategy, demand_list):
    ...
    for t in range(num_periods):
        ...
        cost_mat = (rt_prod + ot_prod) * c_material # Perhitungan biaya bahan baku internal
        ...
        # Ditambahkan cost_mat ke dalam komponen kalkulasi total biaya
...
with tab2:
    ...
    # Cost Breakdown Per Periode (Menambahkan kolom 'Material Cost')
    ...
    with v2:
        # Menambahkan 'Material Cost' ke tumpukan grafik bar per komponen biaya
