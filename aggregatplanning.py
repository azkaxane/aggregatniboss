...
num_periods = 12  # Diubah menjadi 12 periode sesuai instruksi

# Input Demand Base via UI Dataframe (Disiapkan untuk 12 periode dengan pola tren musiman)
...
with tab2:
    ...
    with v2:
        # Menggunakan format Plotly Express yang aman (Bebas dari error stacked=True)
