...
# PENTING: Penulisan HTML dibuat rata kiri untuk menghindari bug formatting di Streamlit
st.markdown(f"""
...
# ------------------------------------------------------------------------------
with tab_laporan:
    # PENTING: Semua tag HTML dari atas ke bawah rata kiri (0 spasi di awal baris)
    st.markdown(f"""
...
<ul style="font-size: 15px; color: #374151; line-height: 1.6; margin-left: 20px;">
