...
# Custom CSS untuk memastikan seluruh teks di dalam card dan rekomendasi berwarna putih
st.markdown("""
<style>
    ...
    .kpi-title { font-size: 14px; color: #9C2828; font-weight: bold; text-transform: uppercase; }
