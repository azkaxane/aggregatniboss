...
<style>
    ...
    .kpi-card small { color: #9C2828; font-weight: 500; } /* Teks kecil KPI menjadi hitam */
    ...
    .recommendation-box h4 { color: #F7F2F2; font-weight: bold; }
    .recommendation-box li { color: #9C2828; }
    .recommendation-box p { color: #9C2828; }
</style>
