...
<style>
    ...
    .kpi-title { font-size: 14px; color: #FAF7F7; font-weight: bold; text-transform: uppercase; }
    .kpi-value { font-size: 24px; color: #000000; font-weight: bold; margin-top: 5px; }
    .kpi-card small { color: #FAF7F7; font-weight: 500; } /* Teks kecil KPI menjadi hitam */
    
    .recommendation-box {
        background-color: #FAF7F7;
        border-radius: 8px;
        padding: 25px;
        border-left: 6px solid #FAF7F7;
        margin-top: 20px;
